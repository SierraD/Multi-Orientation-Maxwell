class preparation(object):
    ...
    def download_dataframe(self):
        """
        A technique to download the data prepared by the preparation.py method as a CSV file named
        "Preparation.py_dfXY_dfXZ.csv".
        ...
        download_df = download_df.rename(columns={'X_XY': 'x_xy [nm]', 
                                                  ...
                                                  'S_X': 'sigma_x [nm]', 
                                                  'S_Z': 'sigma_z [nm]'})
        download_df.to_csv("Preparation.py_dfXY_dfXZ.csv", index=False, encoding='utf-8')
        return self