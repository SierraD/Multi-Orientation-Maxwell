class filtering(object):
    ...
    def __init__(self, data):
        ...
        This method uses the overlapped locations determined by the previous method and 
    ...
    def points(self):
        ...
        points = pd.concat([df["X_XY"], df["Y_XY"], df["Z_XZ"], 
                           ...
                           keys = ["X [nm]", "Y [nm]", "Z [nm]", 
                                   ...
                                   "Intensity XY [Photons]", "Intensity XZ [Photons]"], axis=1).reset_index(drop=True)
        self.points = points
        return self
    ...
    def download_dataframe(self):
        ...
        self.points.to_csv("3DSTORM.csv", index=True, encoding='utf-8')
        return self